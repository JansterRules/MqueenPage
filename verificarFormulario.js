$(document).ready(function() {
    $('#loginForm').submit(function(event) {
        ...
        if (password.length < 8) {
            $('#passwordError').text('La contraseña debe tener al menos 8 caracteres.'); // Mensaje de excepción, ante un errore de la condición de password, ya que debe cu,plir una longitud menor a 8.
            return;
        }
    });

    
    function validarEmail(email) { // Función para vlaidar email 
