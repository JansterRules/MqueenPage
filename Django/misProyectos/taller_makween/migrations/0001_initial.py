# Generated by Django 4.1.2 on 2024-05-29 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_genero', models.ForeignKey(db_column='idGenero', on_delete=django.db.models.deletion.CASCADE, to='taller_makween.genero')),
            ],
        ),
    ]
